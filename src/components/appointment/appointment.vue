<template>
    <div>
        ...
        <!-- 科室列表 -->
        <div v-for="item in filterDepartmentList" class="itemLi" @click="goSchedulingList(item);">
                ...
                .then(
                    res => {
                        ...
                        for (var i = 0; i < list.length; i++) {
                            if (list[i].ksmc) {
                                departmentList = this.addToList(departmentList, {
                                    mc: list[i].ksmc,
                                    id: list[i].ksid
                                })
                            }
